 ...
 * 
 * This file contains the definitions and declarations of the functions 
 ...
 * These classes may be found at multi_cam_detect_utils.cpp.
 */
...
namespace mcmt {
	...
	cv::Mat remove_ground(std::shared_ptr<Camera> & camera);
	cv::Mat apply_bg_subtractions(std::shared_ptr<Camera> & camera);
